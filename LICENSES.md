...
| Public Relay application and its deployment/operation implementation                                            | [AGPL-3.0-or-later](https://spdx.org/licenses/AGPL-3.0-or-later.html) | Applies to `relay-v1/apps/public-relay/**`, `Dockerfile.relay`, Relay deployment validation under `scripts/`, `.github/workflows/relay-container.yml`, and `ops/**`. It does not apply to the v0 library or Relay contracts/adapters. |
